  ...
  return (
    <div className='container mt-5 col-5'>
      ...
      <div class="d-grid gap-2">
        <button type="submit" name="" id="" class="btn btn-success " onClick={handleSubmit}>Login</button>
      </div>     
    
      <div class="d-grid gap-2">
        <button type="submit" name="" id="" class="btn btn-danger mt-3" onClick={LoginwithGoogle}>Login with Google</button>
      </div>
      </form>
    </div>
  )
